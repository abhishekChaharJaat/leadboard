...
const Header = () => {
  ...
  const { theme, isScrolling } = useSelector((state) => state.students);
  return (
    <div className="sticky top-0 w-full  flex flex-col gap-1 p-4 bg-q3-surface-default-glass-normal backdrop-blur-3xl border rounded-b-[12px] z-[100] border-q3-stroke-light">
      <div className={`${isScrolling ? "flex" : ""} items-center gap-4`}>
      ...
      {!isScrolling && (
        <p className="text-q3-neutral-light font-xs  text-[9px] lg:text-base">
